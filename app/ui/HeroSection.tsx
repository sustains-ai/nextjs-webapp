        ...
        <section className="bg-white text-black py-24 relative">
            ...
            >
                ...
                <div className="text-center md:text-left px-6 mt-20 md:-ml-24">
                    ...
                    >
                        Transforming energy challenges <br /> into actionable insights.
                        <span className="text-[#0ABF53]"> Research-powered solutions.</span>
                    ...
                    >
                        AI-powered energy insights tailored for your organization.
                    </motion.p>
